...
### [ ] P0-T0.1: Electron + React + TypeScript 프로젝트 초기화
...
### [ ] P0-T0.2: SQLite + better-sqlite3 설정
...
### [ ] P0-T0.3: Tailwind CSS + shadcn/ui 설정
...
### P0-P1: 기초 설계
- [ ] 감정 안전감 중심 아키텍처 검토
- [ ] AI 격려 메시지 톤 정의 (warm, urgent, humorous, professional)
- [ ] 도망 가능 UI 플로우 설계 (리스케줄 버튼 배치)

### P2: 태스크 관리
- [ ] "2분만 시작" 버튼 실장 (매 화면)
- [ ] AI 쪼개기 제안 (미루기 2회+ 태스크)
- [ ] 진행률 자동 계산 (성취감 강화)
...
### P4: 대시보드 + AI 비서
- [ ] 성취 축적 카운터 (감소 없음) — **필수**
- [ ] "지금 안 할래요" (죄책감 없는 리스케줄) — **필수**
- [ ] 감정 인식 격려 메시지 (시간대, 완료율 기반) — **필수**
- [ ] AI 비서 채팅 (감정 지지)
