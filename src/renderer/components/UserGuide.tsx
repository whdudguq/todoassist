...
const GUIDE_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '3가지 방식으로 집중을 감시하고, 2단계 알림으로 안내합니다.',
      '',
      '[감지 방식]',
      '1. 앱 전환 감지 — 비업무 앱(브라우저, 메신저 등)으로 전환하면 감지합니다.',
      '2. 열린 앱 감지 — 듀얼 모니터에서 클릭 없이 열려있는 비업무 앱도 감지합니다. (최소화 제외)',
      '3. 자리비움 감지 — 마우스/키보드 입력이 없으면 감지합니다.',
      'VS Code, Excel, Teams 등 업무 앱은 허용 목록에 포함되어 알림이 오지 않습니다.',
      '',
      '[2단계 알림]',
      '1단계 (앱 전환 1분 / 자리비움 3분) — 화면 중앙에 오버레이 알림 + 작업표시줄 깜빡임',
      '2단계 (앱 전환 3분 / 자리비움 5분) — TodoAssist 창을 최상단으로 끌어올림 + 오버레이 알림',
      '오버레이의 "돌아갈게요" 버튼을 눌러야 닫힙니다. 집중으로 복귀하면 자동으로 닫힙니다.',
      '',
      '[집중 통계]',
      '태스크 완료 시 통계 컬럼에서 집중/이탈/자리비움 시간과 이탈 앱 목록을 확인할 수 있습니다.',
      '',
      '[알아두세요]',
